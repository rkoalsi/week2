...
describe('MerkleTree', function () {
  ...
  it('\n Insert two new leaves and verify the first leaf in an inclusion proof', async function () {
    ...
    const node14 = (await merkleTree.hashes(14)).toString();
    const Input2 = {
      leaf: '2',
      path_elements: ['2', node12, node14],
      path_index: ['0', '0', '0'],
    };
    ...
    const calldata2 = await groth16.exportSolidityCallData(
      editedProof2,
      editedPublicSignals2
    );
